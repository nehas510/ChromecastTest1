...
import com.example.neha.chromecasttest.R;
import com.example.neha.chromecasttest.Utils.CastUtils;
    ...
    private View buildView(Context context) {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                trackView.setText(CastUtils.buildTrackName(group.getFormat(trackIndex)));
